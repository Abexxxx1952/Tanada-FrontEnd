...
export function userFromServerToProfileFormData(
  ...
  return {
    ...
    instagramUrl: payload[0] ? payload[0].value : "",
    twitterUrl: payload[1] ? payload[1].value : "",
    mainTextContent: payload[2] ? payload[2].value : "",
    yourPhotoUrl: payload[3] ? payload[3].value : "",
    aboutYourself: payload[4] ? payload[4].value : "",
    countryName:
      (payload[5]?.value || "") +
